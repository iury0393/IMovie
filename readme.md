...
A app using the MovieDB as the main source. Used to keep training SwiftUI.
...
```git
git clone https://github.com/iury0393/IMovie
...
1. Fork it (<https://github.com/iury0393/IMovie/fork>)
